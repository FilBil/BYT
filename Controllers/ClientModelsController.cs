...
namespace VetReserve.Controllers
{
    public class ClientModelsController : Controller
    {
        private readonly ClientContext _context;

        public ClientModelsController(ClientContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surname,AnimalName,Password,Email")] ClientModel clientModel)
        {
